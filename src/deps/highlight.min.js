...
var hljs = (function () {
        ...
        return (
            ...
            (function t(r, s) {
                ...
                return (
                    ...
                    s && (r.begin || (r.begin = /\B|\b/), (o.beginRe = n(o.begin)), r.end || r.endsWithParent || (r.end = /\B|\b/), r.end && (o.endRe = n(o.end)), (o.terminatorEnd = c(o.end) || ''), r.endsWithParent && s.terminatorEnd && (o.terminatorEnd += (r.end ? '|' : '') + s.terminatorEnd)),
                    ...
                    (o.matcher = ((e) => {
                        const n = new i();
                        return e.contains.forEach((e) => n.addRule(e.begin, { rule: e, type: 'begin' })), e.terminatorEnd && n.addRule(e.terminatorEnd, { type: 'end' }), e.illegal && n.addRule(e.illegal, { type: 'illegal' }), n;
                    })(o)),
                    o
                );
            })(e)
    ...
    const J = t,
        ...
        ne = (t) => {
            ...
            function f(e, t, i, r) {
                ...
                function b(e, n) {
                    return (
                        ...
                        e.beginScope && (e.beginScope._wrap ? (g(A, w.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (A = '')) : e.beginScope._multi && (u(e.beginScope, n), (A = ''))),
                        (x = Object.create(e, {
                            parent: {
                                value: x
                            }
                ...
                try {
                    ...
                    return S.finalize(), (k = S.toHTML()), { language: e, value: k, relevance: C, illegal: !1, _emitter: S, _top: x };
                } catch (n) {
                    if (n.message && n.message.includes('Illegal')) return { language: e, value: J(t), illegal: !0, relevance: 0, _illegalBy: { message: n.message, index: T, context: t.slice(T - 100, T + 100), mode: n.mode, resultSoFar: k }, _emitter: S };
                    if (s)
                        return {
                            language: e,
                            value: J(t),
            ...
            function y(e) {
                ...
                if (_(t)) return;
                if ((x('before:highlightElement', { el: e, language: t }), e.dataset.highlighted)) return void console.log('Element previously highlighted. To highlight again, first unset `dataset.highlighted`.', e);
    ...
    function Oe(e) {
        const n = e.regex,
            ...
            d = { begin: 'html`', end: '', starts: { end: '`', returnEnd: !1, contains: [e.BACKSLASH_ESCAPE, c], subLanguage: 'xml' } },
            g = {
                begin: 'css`',
                end: '',
                starts: { end: '`', returnEnd: !1, contains: [e.BACKSLASH_ESCAPE, c], subLanguage: 'css' }
            },
            u = { begin: 'gql`', end: '', starts: { end: '`', returnEnd: !1, contains: [e.BACKSLASH_ESCAPE, c], subLanguage: 'graphql' } },
        ...
        const _ = [].concat(m, c.contains),
            ...
            y = { relevance: 0, match: n.either(/\bJSON/, /\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/, /\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/, /\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/), className: 'title.class', keywords: { _: [...Ee, ...ye] } },
            N = {
                variants: [
                    {
    ...
    var Ke = Object.freeze({
            ...
            const n = e.regex,
                ...
                p = {
                    ...
                    contains: [
                        ...
                        { relevance: 0, match: /,/ },
                        { className: 'params', begin: /\(/, end: /\)/, keywords: u, relevance: 0, contains: [t, e.C_BLOCK_COMMENT_MODE, o, l, s, { begin: /\(/, end: /\)/, keywords: u, relevance: 0, contains: ['self', t, e.C_BLOCK_COMMENT_MODE, o, l, s] }] },
                        s,
                        t,
                        e.C_BLOCK_COMMENT_MODE,
                        c
                ...
                _ = {
                    ...
                    contains: [
                        ...
                        { relevance: 0, match: /,/ },
                        {
                            ...
                            keywords: u,
                            relevance: 0,
                            contains: [t, e.C_BLOCK_COMMENT_MODE, o, l, s, { begin: /\(/, end: /\)/, keywords: u, relevance: 0, contains: ['self', t, e.C_BLOCK_COMMENT_MODE, o, l, s] }]
                        },
                        s,
                        t,
                        e.C_BLOCK_COMMENT_MODE,
        ...
        grmr_csharp: (e) => {
            ...
            return {
                ...
                contains: [
                    ...
                    g,
                    a,
                    { beginKeywords: 'class interface', relevance: 0, end: /[{;=]/, illegal: /[^\s:,]/, contains: [{ beginKeywords: 'where class' }, t, u, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE] },
            ...
            return {
                ...
                contains: [
                    ...
                    },
                    {
                        ...
                        keywords: i,
                        contains: [{ className: 'params', begin: /\(/, end: /\)/, keywords: i, relevance: 0, contains: [r, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, me, e.C_BLOCK_COMMENT_MODE] }, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE]
                    },
                    me,
                    r
                ]
                    ...
                    contains: [
                        ...
                        o,
                        {
                            ...
                            contains: [
                                ...
                                { className: 'params', begin: /\(/, end: /\)/, endsParent: !0, keywords: n, relevance: 0, contains: [{ begin: /:/, end: /[=,\/]/, endsWithParent: !0, contains: [d, e.C_LINE_COMMENT_MODE, c], relevance: 0 }, e.C_LINE_COMMENT_MODE, c, s, o, r, e.C_NUMBER_MODE] },
                                c
                            ]
                        },
                        {
        ...
        grmr_less: (e) => {
            ...
            const g = s.concat({
                ...
                b = { begin: i + '\\s*:', returnBegin: !0, end: /[;}]/, relevance: 0, contains: [{ begin: /-(webkit|moz|ms|o)-/ }, n.CSS_VARIABLE, { className: 'attribute', begin: '\\b(' + ce.join('|') + ')\\b', end: /(?=:)/, starts: { endsWithParent: !0, illegal: '[<=$]', relevance: 0, contains: s } }] },
                m = { className: 'keyword', begin: '@(import|media|charset|font-face|(-[a-z]+-)?keyframes|supports|document|namespace|page|viewport|host)\\b', starts: { end: '[;{}]', keywords: c, returnEnd: !0, contains: s, relevance: 0 } },
                p = {
                    className: 'variable',
            ...
            return r.push(e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, m, p, h, b, _, u, n.FUNCTION_DISPATCH), { name: 'Less', case_insensitive: !0, illegal: '[=>\'/<($"]', contains: r };
        },
        grmr_lua: (e) => {
            const n = '\\[=*\\[',
                t = '\\]=*\\]',
        ...
        grmr_markdown: (e) => {
            const n = { begin: /<\/?[A-Za-z_]/, end: '>', subLanguage: 'xml', relevance: 0 },
                t = {
                    ...
                    returnBegin: !0,
                    contains: [{ match: /\[(?=\])/ }, { className: 'string', relevance: 0, begin: '\\[', end: '\\]', excludeBegin: !0, returnEnd: !0 }, { className: 'link', relevance: 0, begin: '\\]\\(', end: '\\)', excludeBegin: !0, excludeEnd: !0 }, { className: 'symbol', relevance: 0, begin: '\\]\\[', end: '\\]', excludeBegin: !0, excludeEnd: !0 }]
                },
                a = {
                    className: 'strong',
                    contains: [],
        ...
        grmr_php: (e) => {
            const n = e.regex,
                ...
                N = { relevance: 0, match: [/\b/, n.concat('(?!fn\\b|function\\b|', p(u).join('\\b|'), '|', p(b).join('\\b|'), '\\b)'), a, n.concat(l, '*'), n.lookahead(/(?=\()/)], scope: { 3: 'title.function.invoke' }, contains: [y] };
            y.contains.push(N);
            ...
            return {
                ...
                contains: [
                    ...
                    { match: /__halt_compiler\(\);/, keywords: '__halt_compiler', starts: { scope: 'comment', end: e.MATCH_NOTHING_RE, contains: [{ match: /\?>/, scope: 'meta', endsParent: !0 }] } },
                    {
                        scope: 'meta',
                        variants: [
                            {
                    ...
                    _,
                    {
                        ...
                        excludeEnd: !0,
                        illegal: '[$%\\[]',
                        contains: [{ beginKeywords: 'use' }, e.UNDERSCORE_TITLE_MODE, { begin: '=>', endsParent: !0 }, { scope: 'params', begin: '\\(', end: '\\)', excludeBegin: !0, excludeEnd: !0, keywords: m, contains: ['self', r, f, e.C_BLOCK_COMMENT_MODE, c, d] }]
                    },
                    {
                        scope: 'class',
                        variants: [
            ...
            contains: [
                {
                    ...
                    subLanguage: 'php',
                    contains: [{ begin: '/\\*', end: '\\*/', skip: !0 }, { begin: 'b"', end: '"', skip: !0 }, { begin: "b'", end: "'", skip: !0 }, e.inherit(e.APOS_STRING_MODE, { illegal: null, className: null, contains: null, skip: !0 }), e.inherit(e.QUOTE_STRING_MODE, { illegal: null, className: null, contains: null, skip: !0 })]
                }
            ]
        }),
        ...
        grmr_r: (e) => {
            ...
            return {
                ...
                contains: [
                    ...
                    e.HASH_COMMENT_MODE,
                    { scope: 'string', contains: [e.BACKSLASH_ESCAPE], variants: [e.END_SAME_AS_BEGIN({ begin: /[rR]"(-*)\(/, end: /\)(-*)"/ }), e.END_SAME_AS_BEGIN({ begin: /[rR]"(-*)\{/, end: /\}(-*)"/ }), e.END_SAME_AS_BEGIN({ begin: /[rR]"(-*)\[/, end: /\](-*)"/ }), e.END_SAME_AS_BEGIN({ begin: /[rR]'(-*)\(/, end: /\)(-*)'/ }), e.END_SAME_AS_BEGIN({ begin: /[rR]'(-*)\{/, end: /\}(-*)'/ }), e.END_SAME_AS_BEGIN({ begin: /[rR]'(-*)\[/, end: /\](-*)'/ }), { begin: '"', end: '"', relevance: 0 }, { begin: "'", end: "'", relevance: 0 }] },
                    {
                        relevance: 0,
                        variants: [
                            {
        ...
        grmr_ruby: (e) => {
            ...
            const p = [
                ...
                { className: 'meta.prompt', begin: '^([>?]>|[\\w#]+\\(\\w+\\):\\d+:\\d+[>*]|(\\w+-)?\\d+\\.\\d+\\.\\d+(p\\d+)?[^\\d][^>]+>)(?=[ ])', starts: { end: '$', keywords: r, contains: m } }
            ];
            return l.unshift(o), { name: 'Ruby', aliases: ['rb', 'gemspec', 'podspec', 'thor', 'irb'], keywords: r, illegal: /\/\*/, contains: [e.SHEBANG({ binary: 'ruby' })].concat(p).concat(l).concat(m) };
        },
        grmr_rust: (e) => {
            const n = e.regex,
                t = { className: 'title.function.invoke', relevance: 0, begin: n.concat(/\b/, /(?!let|for|while|if|else|match\b)/, e.IDENT_RE, n.lookahead(/\s*\(/)) },
            ...
            return {
                name: 'Rust',
                aliases: ['rs'],
                keywords: { $pattern: e.IDENT_RE + '!?', type: r, keyword: ['abstract', 'as', 'async', 'await', 'become', 'box', 'break', 'const', 'continue', 'crate', 'do', 'dyn', 'else', 'enum', 'extern', 'false', 'final', 'fn', 'for', 'if', 'impl', 'in', 'let', 'loop', 'macro', 'match', 'mod', 'move', 'mut', 'override', 'priv', 'pub', 'ref', 'return', 'self', 'Self', 'static', 'struct', 'super', 'trait', 'true', 'try', 'type', 'typeof', 'unsafe', 'unsized', 'use', 'virtual', 'where', 'while', 'yield'], literal: ['true', 'false', 'Some', 'None', 'Ok', 'Err'], built_in: i },
                illegal: '</',
                contains: [
                    e.C_LINE_COMMENT_MODE,
        ...
        grmr_scss: (e) => {
            ...
            return {
                ...
                contains: [
                    ...
                    { begin: /:/, end: /[;}{]/, relevance: 0, contains: [n.BLOCK_COMMENT, r, n.HEXCOLOR, n.CSS_NUMBER_MODE, e.QUOTE_STRING_MODE, e.APOS_STRING_MODE, n.IMPORTANT, n.FUNCTION_DISPATCH] },
                    { begin: '@(page|font-face)', keywords: { $pattern: i, keyword: '@page @font-face' } },
                    {
                        ...
                        contains: [{ begin: i, className: 'keyword' }, { begin: /[a-z-]+(?=:)/, className: 'attribute' }, r, e.QUOTE_STRING_MODE, e.APOS_STRING_MODE, n.HEXCOLOR, n.CSS_NUMBER_MODE]
                    },
                    n.FUNCTION_DISPATCH
                ]
            };
        },
        grmr_shell: (e) => ({ name: 'Shell Session', aliases: ['console', 'shellsession'], contains: [{ className: 'meta.prompt', begin: /^\s{0,3}[/~\w\d[\]()@-]*[>%$#][ ]?/, starts: { end: /[^\\](?=\s*$)/, subLanguage: 'bash' } }] }),
        grmr_sql: (e) => {
            const n = e.regex,
                t = e.COMMENT('--', '$'),
        ...
        grmr_typescript: (e) => {
            const n = Oe(e),
                ...
                r = { beginKeywords: 'interface', end: /\{/, excludeEnd: !0, keywords: { keyword: 'interface extends', built_in: a }, contains: [n.exports.CLASS_REFERENCE] },
                s = { $pattern: _e, keyword: he.concat(['type', 'namespace', 'interface', 'public', 'private', 'protected', 'implements', 'declare', 'abstract', 'readonly', 'enum', 'override']), literal: fe, built_in: ve.concat(a), 'variable.language': we },
            ...
            return (
                n.contains.push('self'),
                {
                    ...
                    contains: [
                        ...
                        { className: 'keyword', match: /\b(f32|f64|i32|i64)(?:\.(?:abs|add|and|ceil|clz|const|convert_[su]\/i(?:32|64)|copysign|ctz|demote\/f64|div(?:_[su])?|eqz?|extend_[su]\/i32|floor|ge(?:_[su])?|gt(?:_[su])?|le(?:_[su])?|load(?:(?:8|16|32)_[su])?|lt(?:_[su])?|max|min|mul|nearest|neg?|or|popcnt|promote\/f32|reinterpret\/[fi](?:32|64)|rem_[su]|rot[lr]|shl|shr_[su]|store(?:8|16|32)?|sqrt|sub|trunc(?:_[su]\/f(?:32|64))?|wrap\/i64|xor))\b/ },
                        { className: 'number', relevance: 0, match: /[+-]?\b(?:\d(?:_?\d)*(?:\.\d(?:_?\d)*)?(?:[eE][+-]?\d(?:_?\d)*)?|0x[\da-fA-F](?:_?[\da-fA-F])*(?:\.[\da-fA-F](?:_?[\da-fA-D])*)?(?:[pP][+-]?\d(?:_?\d)*)?)\b|\binf\b|\bnan(?::0x[\da-fA-F](?:_?[\da-fA-D])*)?\b/ }
                    ]
                }
            );
        },
        grmr_xml: (e) => {
            ...
            return {
                ...
                contains: [
                    ...
                    { className: 'tag', begin: n.concat(/</, n.lookahead(n.concat(t, n.either(/\/>/, />/, /\s/)))), end: /\/?>/, contains: [{ className: 'name', begin: t, relevance: 0, starts: l }] },
                    {
                        className: 'tag',
